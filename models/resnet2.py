...
class BasicBlock2(nn.Module):
    ...
    #BasicBlock2 and BottleNeck2 block
...
class ResNet2(nn.Module):
    ...
    def forward(self, x):
        ...
        # output = torch.sigmoid(output)  # TODO TODO TODO

        return output

def ResNet18_2(num_classes=100):
    """ return a ResNet 18 object
    """
    return ResNet2(BasicBlock2, [2, 2, 2, 2], num_classes)

def resnet34_2(num_classes=100):
    """ return a ResNet 34 object
    """
    return ResNet2(BasicBlock2, [3, 4, 6, 3], num_classes)
